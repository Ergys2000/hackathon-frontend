...
const SearchField = (props: any) => {
	...
	return (
		<div onClick={() => setOpen(true)}
			className={`${open ? "w-64 rounded-xl p-2 bg-gray-200" : "w-12 rounded-full p-1"} ${focus ? "border-indigo-700" : "border-black" } flex flex-row justify-center transition-all duration-100
			items-center border`}>
